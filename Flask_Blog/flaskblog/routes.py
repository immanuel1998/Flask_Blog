...
# posts = [
#     {
#         'author':'Immanuel Cristobal',
#         'title': 'Blog Post 1',
#         'contenct': 'First post content',
#         'date_posted': 'April 20, 2018'
#     },
#     {
#         'author':'Jake Balasanos',
#         'title': 'Blog Post 2',
#         'contenct': 'Second post content',
...
def home():
    ...
    posts = Post.query.order_by(Post.date_posted.asc()).paginate(page=page, per_page=2)
